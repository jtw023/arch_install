...
if [[ $UID -ne 0 ]]; then
	...
	touch /etc/doas.conf
	echo 'permit nopass '$LOGNAME' as root' > /etc/doas.conf
	cat /etc/doas.conf
    ...
    chmod -v +x /home/$LOGNAME/Random-Scripts/*


    echo "################## Making directories and moving packages ##################"

    if [ -d "/usr/share/zsh/themes" ]; then
        cp -v /home/$LOGNAME/.config/zsh/bira.zsh-theme /usr/share/zsh/themes/
    else
    ...
    if [ -d "/usr/share/rofi/themes" ]; then
        cp -v /home/$LOGNAME/.config/rofi/arthur.rasi /usr/share/rofi/themes/arthur.rasi
    else
        mkdir -pv /usr/share/rofi/themes
        cp -v /home/$LOGNAME/.config/rofi/arthur.rasi /usr/share/rofi/themes/arthur.rasi
    fi

    cp -v /home/$LOGNAME/.config/Xresources/.Xresources /home/$LOGNAME/.Xresources
    cp -v /home/$LOGNAME/.config/xinit/.xinitrc /home/$LOGNAME/.xinitrc
    cp -v /home/$LOGNAME/.config/Xauthority/.Xauthority /home/$LOGNAME/.Xauthority
    cp -v /home/$LOGNAME/.config/zsh/.zshrc.root /root/.zshrc
    cp -v /home/$LOGNAME/.config/zsh/.zshenv /home/$LOGNAME/.zshenv
	cp -v /home/$LOGNAME/Random-Scripts/set_screens.sh /usr/local/bin/set_screens.sh
    ...
    chown -Rv $LOGNAME:wheel /home/$LOGNAME/
